...
input and output text and run the recursive prefix_to_postfix function to convert each
...
if __name__ == "__main__":
    ...
    with open(args.input_file, encoding="utf-8") as file:
        ...
        # the line without any blank characters
        for line in remove_blanks(file):
            # First convert the line's prefix expression to postfix
            # then write that converted line to the output file
            # and write a new line as well to match the format of
            # input file
